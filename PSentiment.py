...
st.set_page_config(page_title="Sentiment Analyzer", page_icon=":money_with_wings:")


# Add a header image
header = st.container()
with header:
    st.image('https://global-uploads.webflow.com/5dd3ac2a77520f09d34aa5b0/63e1fb2900cb7b2ac71274fb_How%20to%20write%20a%20financial%20analysis%20report%20-%20main%20banner.png', use_column_width=True)
